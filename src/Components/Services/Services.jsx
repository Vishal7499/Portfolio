  ...
  return (
    <div className="services" id='Skills'>
      <div className="awesome">
        ...
        <span>
        Versatile full-stack developer proficient in creating seamless, innovative solutions for <br /> optimal user experiences. Expertise spans both front-end and back-end technologies.
        </span>
